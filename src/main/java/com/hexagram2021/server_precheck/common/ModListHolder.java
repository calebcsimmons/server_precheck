...
/**
 * Holds the client's mod list. This is set by the client initializer
 * and read by the mixin when creating handshake packets.
 * <p>
 * This class is thread-safe: the mod list is stored as a volatile reference
 * to an immutable list, ensuring safe publication across threads.
 */
public class ModListHolder {
    private static volatile List<String> clientMods = Collections.emptyList();

    /**
     * Sets the client mod list. The provided list is copied and made immutable
