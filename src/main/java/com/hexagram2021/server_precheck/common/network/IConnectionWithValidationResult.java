...
/**
 * Interface for storing mod validation results on a Connection.
 * This allows the validation to happen during handshake, but the kick
 * to be deferred until after authentication (when we know the player's UUID).
 */
