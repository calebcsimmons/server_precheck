...
/**
 * Builds disconnect messages for clients that fail mod list validation. Supports both custom
 * messages and detailed mismatch reports with i18n.
 */
