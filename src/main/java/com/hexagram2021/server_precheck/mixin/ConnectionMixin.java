...
/**
 * Mixin to add validation result storage to Connection.
 * This allows us to store the mod validation result during handshake
 * and retrieve it later after authentication to decide whether to kick the player.
 */
...
public class ConnectionMixin implements IConnectionWithValidationResult {
    ...
    @Unique
    @Nullable
    private MutableComponent serverPreCheck$validationFailureMessage;
